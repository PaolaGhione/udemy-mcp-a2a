...
# # if you want you can run stateless http server,
# but then you will not be able to use redis to store session data
mcp = FastMCP()
...
def greetings(name: str, ctx: Context) -> Greeting:
    """A tool function that accepts a parameter called name
    and returns a personalised greeting message."""
